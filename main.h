...
enum errors {
    ...
    EXTERN_NO_LABEL, EXTERN_INVALID_LABEL, EXTERN_TOO_MANY_OPERANDS, COMMAND_UNEXPECTED_CHAR, COMMAND_TOO_MANY_OPERANDS,
    COMMAND_INVALID_NUMBER_OF_OPERANDS, COMMAND_INVALID_METHOD
};
